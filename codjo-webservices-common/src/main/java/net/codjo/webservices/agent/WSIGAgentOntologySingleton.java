package net.codjo.webservices.agent;
import com.tilab.wsig.agent.WSIGAgent;
 ...
 *
 */
public class WSIGAgentOntologySingleton extends GatewayAgent implements WSIGConstants {
    ...
    private boolean isWSIGService(ServiceDescription sd) {
        ...
        while (it.hasNext()) {
            ...
            if (WSIGConstants.WSIG_FLAG.equalsIgnoreCase(property.getName()) && "true"
                  .equals(property.getValue().toString())) {
                return true;
            }
        }
        return false;
    ...
    private String getServicePrefix(ServiceDescription sd) {
        ...
        while (it.hasNext()) {
            ...
            if (WSIGConstants.WSIG_PREFIX.equalsIgnoreCase(property.getName()) && property.getValue().toString().length()
                                                                           != 0) {
                return property.getValue().toString() + WSDLConstants.SEPARATOR;
            }
        }
        return "";
    }
    ...
    public Class getMapperClass(ServiceDescription sd) throws Exception {
        ...
        while (it.hasNext() && !mapperFound) {
            property = (Property)it.next();
            if (WSIGConstants.WSIG_MAPPER.equalsIgnoreCase(property.getName())) {
                mapperClassName = (String)property.getValue();
                mapperFound = true;
            }
        }
